...
class nnUNetSegClsDataLoader2D(nnUNetDataLoaderBase):
    def __init__(self,
                 data: nnUNetDataset,
                 batch_size: int,
    ...
    def generate_train_batch(self):
        ...
        cls_all = np.zeros((self.batch_size, 1), dtype=np.int64)
        case_properties = []
        ...
        for j, current_key in enumerate(selected_keys):
            ...
            data, seg, classification_label, properties = self._data.load_case(current_key)
